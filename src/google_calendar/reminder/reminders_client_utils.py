#####################################################
# Review this code, some functios looks like cancer #
#####################################################
...
APP_KEYS_FILE = f'{script_dir}/.reminder_keys.json'
USER_OAUTH_DATA_FILE = os.path.expanduser(f'{script_dir}/.google-reminder-oauth')
...
def authenticate() -> httplib2.Http:
    ...
    if credentials is None or credentials.invalid:
        credentials = tools.run_flow(
            ...
            storage,
            tools.argparser.parse_args([]) #Multi args fix
        )
